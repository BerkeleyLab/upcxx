...
struct T {
  static void show_stats(int line, char const *title, 
                         int expected_ctors, int expected_copies, int expected_moves) UPCXX_ATTRIB_NOINLINE;
...
void UPCXX_ATTRIB_NOINLINE test_rpc1() {
...
void UPCXX_ATTRIB_NOINLINE test_rpc2() {
...
void UPCXX_ATTRIB_NOINLINE test_rpc3() {
...
void UPCXX_ATTRIB_NOINLINE test_rpc4() {
  // function object
...
void UPCXX_ATTRIB_NOINLINE test_rpc5() {
  // rpc_ff
...
int x = 0;
int *lp = &x;
void UPCXX_ATTRIB_NOINLINE test_rput_rpc1() {
  // as_rpc
...
void UPCXX_ATTRIB_NOINLINE test_rput_rpc2() {
...
void UPCXX_ATTRIB_NOINLINE test_rput_rpc3() {
    {
      T t;
...
void UPCXX_ATTRIB_NOINLINE test_vis_rpc() {
    // VIS rput: as_rpc
    std::size_t sz = 1;
...
void UPCXX_ATTRIB_NOINLINE test_copy_rpc() {
    // copy: as_rpc
...
void UPCXX_ATTRIB_NOINLINE test_copy_rpc_cuda() {
